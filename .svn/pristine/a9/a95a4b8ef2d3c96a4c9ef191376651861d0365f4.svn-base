...
add wave -noupdate /d_flip_flop_tb/reset_n_tb
add wave -noupdate /d_flip_flop_tb/que_tb
add wave -noupdate /d_flip_flop_tb/que_n_tb
...
add wave -noupdate /d_flip_flop_tb/UUT/reset_n
add wave -noupdate /d_flip_flop_tb/UUT/que
add wave -noupdate /d_flip_flop_tb/UUT/que_n
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {98804 ps} 0}
...
update
WaveRestoreZoom {0 ps} {275100 ps}
