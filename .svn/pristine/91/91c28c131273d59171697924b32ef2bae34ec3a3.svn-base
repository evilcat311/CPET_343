...
BEGIN
	...
	GENERIC MAP (
		...
		init_file => "../../src/rom_data/data.mif",
...
-- Retrieval info: PRIVATE: MIFfilename STRING "../../src/rom_data/data.mif"
...
-- Retrieval info: CONSTANT: INIT_FILE STRING "../../src/rom_data/data.mif"
